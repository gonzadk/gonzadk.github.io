...
import { TimelineList, TimelineItem } from '../TimelineList/TimelineList';
  ...
  private timelineList: TimelineItem[] = [
    {
      ...
      description: 'Fullstack developer responsible for end-to-end app development. ' +
    ...
    },
    {
      ...
      description: 'Worked on a busy team, sometimes under pressure, ' +
    ...
    },
    {
      ...
      description: 'Great startup Company in which I worked on backend and frontend ' +
    ...
    },
    {
      ...
      description: 'Helped on practical classes and gave classes in some cases. ' +
