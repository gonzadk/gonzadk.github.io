...
class Skills extends React.Component<SkillsProps, SkillsState> {
  ...
  skillColumn(skillsColumn: SkillColumn, index: number) {
    return (
      <div className="col-md-4 col-sm-4 col-xs-12" key={`column-${index}`}>
        {
      ...
      <section id="skills" className="generic-scroll-reveal skills-container section">
        <div className="container">
          <div className="section-title">
            <h4 className="text-uppercase text-center"><i className="title-icon fa fa-sliders"/>Skills</h4>
          </div>
          <div className="row">
              ...
              <div className="card">
                <div className="card-content">
                  <div className="row">
                    ...
                    {
                      _.map(this.skillColumns, (skillsColumn, index) => (
                        this.skillColumn(skillsColumn, index)
                      ))
                    }
                  </div>
                </div>
